...
namespace AeccApp.Core.ViewModels
{
    class AllYourRequestsListViewModel : ViewModelBase
    {
        ...
        void OnHospitalTabCommand(object obj)
        {
            ...
            RequestModel mockRequest = new RequestModel("tipo", "location", "fecha", "hora", "comentarios", new AddressModel("Hospital rey Juan Carlos", "Fake street", "Madrid", "123", "1a", "", new Models.Requests.Position(0, 0)));
        ...
        void OnHomeTabCommand(object obj)
        {
            ...
            RequestModel mockRequest = new RequestModel("tipo", "location", "fecha", "hora", "comentarios", new AddressModel("Mi casa", "Fake street", "Madrid", "123", "1a", "", new Models.Requests.Position(0, 0)));
