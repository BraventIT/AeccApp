...
namespace AeccBot.MessageRouting.DataStore
{
    ...
    public interface IRoutingDataManager
    {
        ...
        bool UpdateCheckAggregationParty(Party party);
        ...
        bool IsInAggregation(Party senderParty);

        bool IsPendingRequest(Party senderParty);

        bool IsBot(Party senderParty);
        ...
        IList<Party> GetUserPartiesWithoutActivity(DateTimeOffset maxDate);
        IList<Party> GetPendingRequestsWithoutActivity(DateTimeOffset maxDate);
        IList<Party> GetAggregationsWithoutActivity(DateTimeOffset maxDate);

        void UpdateUserPartyActivity(Party party, bool allowBackchannel = false);

        void UpdatePartyConnectionData(Party party, IActivity activity);
        #endregion
